...
import { getActiveAccountEmail, loadAccountTokens, saveAccountTokens, accountExists, updateLastUsed } from '../accounts/index.js';
...
export class TokenManager {
    ...
    async refreshToken() {
        ...
        for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
            try {
                ...
                if (isPermanentError) {
                    ...
                    throw new TokenRefreshError(`Refresh token invalid or expired. Please login again.`, { cause: lastError, isRetryable: false });
                }
        ...
        throw new TokenRefreshError(`Failed to refresh token after ${MAX_RETRIES} attempts`, { cause: lastError, isRetryable: true });
    }
    /**
 ...
 */
export function getTokenManagerForAccount(email) {
