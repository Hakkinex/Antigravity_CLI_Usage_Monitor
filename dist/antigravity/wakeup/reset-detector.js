...
import { loadWakeupConfig, loadResetState, updateResetState } from './storage.js';
 ...
 */
export function isModelUnused(model) {
 ...
 */
export async function detectResetAndTrigger(snapshot) {
    ...
    for (const model of snapshot.models) {
        ...
        if (!model.modelId) {
            debug('reset-detector', 'Skipping model without modelId');
            continue;
        }
