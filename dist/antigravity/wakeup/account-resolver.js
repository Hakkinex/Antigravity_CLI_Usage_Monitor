 ...
 */
export function resolveAccounts(selectedAccounts) {
 ...
 */
export function hasValidAccounts(selectedAccounts) {
    return resolveAccounts(selectedAccounts).length > 0;
}
/**
 * Get a friendly description of account resolution state
 */
export function getAccountResolutionStatus(selectedAccounts) {
