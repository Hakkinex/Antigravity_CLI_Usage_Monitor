...
export class NotLoggedInError extends Error {
  constructor(message = 'Not logged in. Configure Antigravity auth before watching real quota.') {
    super(message)
...
export class NoAuthMethodAvailableError extends Error {
  constructor(message = 'Unable to fetch quota: Antigravity is not running and no authenticated account is available.\n\nPlease run Antigravity in your IDE or configure Google auth before watching real quota.') {
    super(message)
